...
// --- Magic link auth intentionally not implemented ---
// TRACE's architecture avoids email/phone identifiers by design.
// Operators use callsign + access code. Reporters use invite codes.
// Magic links would require storing email addresses, violating the
// three-vault pseudonymous architecture. Do not add email-based auth.
